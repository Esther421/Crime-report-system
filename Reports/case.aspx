<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="case.aspx.cs" Inherits="Reports_case" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <div class="card-body">
            <h1  class="text-dark">Report Of all Users That reported A Case</h1>

            <p>Select filter place</p>
